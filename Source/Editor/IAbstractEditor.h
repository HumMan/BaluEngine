...
namespace EngineInterface
{
	...
	BALUENGINEDLL_API IAbstractEditor* CreateEditor(EngineInterface::IBaluWorldObject*,
		EngineInterface::TDrawingHelperContext drawing_context, EngineInterface::IBaluWorldInstance* world_instance);
