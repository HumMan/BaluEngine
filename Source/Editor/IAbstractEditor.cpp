...
namespace EngineInterface
{
	...
	//	return result;
	//}
	IAbstractEditor* CreateEditor(IBaluWorldObject* source, TDrawingHelperContext drawing_context, IBaluWorldInstance* world_instance)
	{
		auto scene = dynamic_cast<IBaluScene*>(source);
		if (scene)
