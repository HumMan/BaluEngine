...
void TScriptClassesRegistry::RegisterExternal(const char* source, const char* name, size_t size, bool is_interface, const char* c_name)
{
	get_external_class_registry().push_back(TExternalClassInfo(source,name, size, is_interface, c_name));
}
