...
VerticesDetectionType TextureConverter::GetPolygonDetectionType()
{
	return _polygonDetectionType;
}
void TextureConverter::SetPolygonDetectionType(VerticesDetectionType value)
{
...
/// </summary>
bool TextureConverter::GetHoleDetection()
{
	return _holeDetection;
}
void TextureConverter::SetHoleDetection(bool value)
{
...
/// </summary>
bool TextureConverter::GetMultipartDetection()
{
	return _multipartDetection;
}
void TextureConverter::SetMultipartDetection(bool value)
{
...
/// </summary>
bool TextureConverter::GetPixelOffsetOptimization()
{
	return _pixelOffsetOptimization;
}
void TextureConverter::SetPixelOffsetOptimization(bool value)
{
...
/// </summary>
TMatrix2 TextureConverter::GetTransform()
{
	return _transform;
}
void TextureConverter::SetTransform(TMatrix2 value)
{
	_transform = value;
}
...
/// </summary>
char TextureConverter::GetAlphaTolerance()
{
	return (char)(_alphaTolerance);
	//return (char)(_alphaTolerance >> 24);
}
void TextureConverter::SetAlphaTolerance(unsigned int value)
{
	//_alphaTolerance = (unsigned int)value << 24;
	_alphaTolerance = (unsigned int)value;
}
/// <summary>
/// Default is 1.5f.
/// </summary>
float TextureConverter::GetHullTolerance()
{
	return _hullTolerance;
}
void TextureConverter::SetHullTolerance(float value)
{
	if (value > 4.0f)
	{
		_hullTolerance = 4.0f;
...
TextureConverter::TextureConverter(Nullable<char> alphaTolerance, Nullable<float> hullTolerance,
...
TextureConverter::TextureConverter(unsigned int* data, int data_length, int width)
{
	Initialize(data, data_length, width, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr);
}

TextureConverter::TextureConverter(unsigned int* data, int data_length, int width, Nullable<char> alphaTolerance, Nullable<float> hullTolerance,
	Nullable<bool> holeDetection, Nullable<bool> multipartDetection, Nullable<bool> pixelOffsetOptimization, Nullable<TMatrix2> transform)
{
...
void TextureConverter::Initialize(unsigned int* data, int data_length, Nullable<int> width, Nullable<char> alphaTolerance, Nullable<float> hullTolerance,
	Nullable<bool> holeDetection, Nullable<bool> multipartDetection, Nullable<bool> pixelOffsetOptimization, Nullable<TMatrix2> transform)
{
	InitFields();
...
void TextureConverter::SetTextureData(unsigned int* data, int data_length, int width)
{
	if (data == nullptr)
...
Vertices TextureConverter::DetectVertices(unsigned int* data, int data_length, int width)
{
...
Vertices TextureConverter::DetectVertices(unsigned int* data, int data_length, int width, bool holeDetection)
{
	TextureConverter tc(data, data_length, width);
...
std::vector<Vertices> TextureConverter::DetectVertices(unsigned int* data, int data_length, int width, float hullTolerance, char alphaTolerance, bool multiPartDetection, bool holeDetection)
{
	TextureConverter tc(data, data_length, width);
...
std::vector<Vertices> TextureConverter::DetectVertices()
{
...
void TextureConverter::ApplyTriangulationCompatibleWinding(std::vector<Vertices>& detectedPolygons)
{
...
void TextureConverter::ApplyTransform(std::vector<Vertices>& detectedPolygons)
{
	for (int i = 0; i < detectedPolygons.size(); i++)
		detectedPolygons[i].Transform(_transform);
}

bool TextureConverter::IsSolid(TVec2 v)
{
...
bool TextureConverter::IsSolid(int x, int y)
{
...
bool TextureConverter::IsSolid(int index)
{
...
bool TextureConverter::InBounds(TVec2 coord)
{
...
Nullable<TVec2> TextureConverter::SearchHoleEntrance(Vertices polygon, Nullable<TVec2> lastHoleEntrance)
{
	if (polygon.size() == 0)
...
bool TextureConverter::DistanceToHullAcceptableHoles(Vertices polygon, TVec2 point, bool higherDetail)
{
	if (polygon.size() < 3)
		throw std::invalid_argument("'polygon.MainPolygon.size()' can't be less then 3.");
...
bool TextureConverter::DistanceToHullAcceptable(Vertices polygon, TVec2 point, bool higherDetail)
{
	if (polygon.size() < 3)
...
bool TextureConverter::InPolygon(Vertices polygon, TVec2 point)
{
...
Nullable<TVec2> TextureConverter::GetTopMostVertex(Vertices vertices)
{
...
float TextureConverter::GetTopMostCoord(Vertices vertices)
{
...
float TextureConverter::GetBottomMostCoord(Vertices vertices)
{
...
std::vector<float> TextureConverter::SearchCrossingEdgesHoles(Vertices polygon, int y)
{
...
std::vector<float> TextureConverter::SearchCrossingEdges(Vertices polygon, int y)
{
	// sick-o-note:
...
bool TextureConverter::SplitPolygonEdge(Vertices polygon, TVec2 coordInsideThePolygon, int& vertex1Index, int& vertex2Index)
{
	TVec2 slope;
...
/// <returns></returns>
Vertices TextureConverter::CreateSimplePolygon(TVec2 entrance, TVec2 last)
{
	...
	if (entrance == TVec2(0.0f) || !InBounds(entrance))
	{
...
bool TextureConverter::SearchNearPixels(bool searchingForSolidPixel, TVec2& current, TVec2& foundPixel)
{
...
bool TextureConverter::IsNearPixel(TVec2& current, TVec2& near)
{
	for (int i = 0; i < ClosepixelsLength; i++)
	{
		int x = (int)current[0] + _closePixels[i][0];
...
bool TextureConverter::SearchHullEntrance(TVec2& entrance)
{
...
bool TextureConverter::SearchNextHullEntrance(std::vector<Vertices> detectedPolygons, TVec2 start, Nullable<TVec2>& entrance)
{
	int x;
...
bool TextureConverter::GetNextHullPoint(TVec2& last, TVec2& current, TVec2& next)
{
	int x;
	int y;
...
bool TextureConverter::SearchForOutstandingVertex(Vertices hullArea, TVec2& outstanding)
{
...
int TextureConverter::GetIndexOfFirstPixelToCheck(TVec2& last, TVec2& current)
{
	// .: pixel
	// l: last position
	// c: current position
